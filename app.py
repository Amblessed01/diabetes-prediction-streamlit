...
# Function to load data with your specific path
def load_data():
    """Load the diabetes dataset from your specific path"""
    try:
...
if app_mode == "Home":
    ...
    if not model_files:
        ...
        st.dataframe(sample_metrics.style
    ...
    **Disclaimer**: This tool is for educational and research purposes only. 
    ...
    team_members = [
        {"name": "Dr. Sarah Chen", "role": "Lead Data Scientist", "expertise": "ML in Healthcare"},
        {"name": "Alex Rodriguez", "role": "ML Engineer", "expertise": "Model Deployment"},
        {"name": "Dr. Michael Park", "role": "Medical Advisor", "expertise": "Endocrinology"}
    ]
